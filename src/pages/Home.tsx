...
import {
  ShieldCheck, Zap, Trash2, Download, Lock, ChevronDown, Shield,
  AlertTriangle, Globe, Smartphone, Clock, MapPin, CheckCircle2,
  XCircle, Server, Heart, Scan, FileDigit, MousePointerClick
} from 'lucide-react';
...
const SCAN_EFFECT = "/scan-effect.webp";
const SHIELD_IMG = "/shield.webp";
...
export default function Home() {
  ...
  const {
    images, isProcessing, progress, stats, addFiles, removeImage,
    clearAll, cleanAll, downloadImage, downloadAllZip,
  } = useImageProcessor();
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0a0c] font-sans text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-xl">
        <div className="container flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="outline" size="sm" onClick={handleDonation} className="border-[#ff0055]/30 text-[#ff0055] hover:bg-[#ff0055]/10 font-bold h-8">
      ...
      <main className="flex-1">
        ...
        {/* SECTION VINTED - RESTAURÉE AVEC TEXTURE HERO BG */}
        <section className="container py-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-4xl mx-auto p-8 rounded-xl border border-[#ffb000]/20 bg-[#ffb000]/5 relative overflow-hidden">
            {/* Texture de fond Cyber/Fumée restaurée */}
            <div className="absolute inset-0 z-0">
               <img src={HERO_BG} alt="" className="w-full h-full object-cover opacity-20 mix-blend-overlay" />
            </div>
            {/* Coins décoratifs Tank */}
        ...
        {/* POURQUOI VOS PHOTOS VOUS TRAHISSENT (TABLETTE) */}
        <section className="container py-16 text-center">
            <div className="mb-12">
                ...
                {/* Image Tablette SANS le mot Scan Analysis (NETTOYÉ) */}
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto mb-12 rounded-xl overflow-hidden border border-white/10 shadow-2xl bg-black">
                  <img src={SCAN_EFFECT} alt="Scan Analysis" className="w-full h-auto object-cover opacity-90" />
                </motion.div>
            </div>
        ...
        {/* COMMENT ÇA FONCTIONNE (3 ÉTAPES RESTAURÉES) */}
        <section className="container py-12">
        ...
        {/* ARCHITECTURE (SHIELD WATERMARK RESTAURÉ + 3 LIGNES) */}
        <section className="container py-16">
            <div className="text-center mb-10">
                <h2 className="text-3xl font-bold mb-2">{t('info.arch_title')}</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div className="relative border border-[#00ff41]/20 bg-[#00ff41]/5 p-8 rounded-xl h-full overflow-hidden">
                    {/* SHIELD WATERMARK - En filigrane arrière-plan */}
                    <img 
                        src={SHIELD_IMG} 
                        alt="" 
                        className="absolute -right-16 -bottom-16 w-80 h-80 opacity-10 pointer-events-none z-0 object-contain" 
                    />
