      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border/40">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-10 h-10 rounded bg-muted/50 flex-shrink-0 overflow-hidden border border-border/30">
            {image.previewUrl ? (
              <img src={image.previewUrl} loading="lazy" decoding="async" alt={t("card.preview_alt", "Aperçu du fichier en cours de nettoyage")} className="w-full h-full object-cover" />
            ) : (
