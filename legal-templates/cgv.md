...
La souscription s'effectue en ligne via la page de paiement Lemon Squeezy. Le paiement est exigible à
la commande. Les moyens de paiement acceptés sont ceux proposés par Lemon Squeezy. La commande est
confirmée par un e-mail récapitulatif et une facture émise par Lemon Squeezy.
...
Pour les contrats conclus à distance, le consommateur dispose en principe d'un délai de **quatorze
(14) jours** pour se rétracter sans motif (art. L221-18 du Code de la consommation).

> **Renoncement pour contenu/service numérique à exécution immédiate (art. L221-28, 13°).** Le service
> GhostMeta étant un **contenu numérique fourni sans support matériel**, dont l'exécution commence
> **immédiatement** après la souscription, le client, en cochant la case prévue au paiement :
...
GhostMeta est fourni « en l'état ». Les garanties légales de conformité et des vices cachés
prévues par le droit applicable demeurent, dans la mesure où elles s'appliquent à un service/contenu
numérique. Aucune garantie n'est donnée quant à un résultat spécifique (ex. suppression exhaustive de
tout type de métadonnée ou marquage).
...
Les dispositions impératives du pays de résidence du consommateur dans l'UE restent applicables.
